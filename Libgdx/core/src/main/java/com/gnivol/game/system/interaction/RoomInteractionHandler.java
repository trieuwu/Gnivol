...
public class RoomInteractionHandler implements InteractionCallback {
    ...
    public void onObjectInteracted(GameObject obj) {
        ...
        if ("fridge".equals(id)) {
            screen.openOverlay("images/tu_opened_final.png", "fridge");
            return;
        }

        if ("wardrobe".equals(id)) {
            screen.openOverlay("images/tu_opened_laycv_final.png", "wardrobe");
            return;
        }
